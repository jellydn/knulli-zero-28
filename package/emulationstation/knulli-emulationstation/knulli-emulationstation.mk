...
ifeq ($(KNULLI_EMULATIONSTATION_KEY_SCREENSCRAPER_DEV_LOGIN),)
$(warning SCREENSCRAPER_DEV_LOGIN empty: ScreenScraper UI will be compiled out. Provide package/emulationstation/knulli-emulationstation/keys.txt)
endif
