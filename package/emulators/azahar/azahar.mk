...
AZAHAR_DEPENDENCIES += host-cmake boost fdk-aac ffmpeg fmt openal sdl2
...
# Override cmake to use the host-cmake version
AZAHAR_CONF_ENV += PATH=$(HOST_DIR)/bin:$(AZAHAR_CONF_ENV_PATH)
